"""
Report Generator for Vyoma AI Security Scanner
...
class ReportGenerator:
    ...
    async def generate_html_report(self, scan_results: Dict[str, Any]) -> str:
        ...
        filename = f"Vyoma_report_{domain}_{timestamp}.html"
...
<head>
    ...
    <title>Vyoma AI Security Report - {scan_results['target']}</title>
...
<body>
    <div class="main-container">
        ...
        <div class="report-header">
            <h1 class="report-title">
                <i class="fas fa-shield-alt"></i> Vyoma AI Security Report
            </h1>
        ...
        html_content += f"""
        <div class="footer">
            <p><i class="fas fa-robot"></i> Generated by Vyoma AI Security Scanner</p>
    ...
    async def generate_json_report(self, scan_results: Dict[str, Any]) -> str:
        ...
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        domain = urlparse(scan_results['target']).netloc.replace('.', '_')
        filename = f"Vyoma_report_{domain}_{timestamp}.json"
        filepath = Path(self.config.output_dir) / filename
