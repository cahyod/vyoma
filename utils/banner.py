"""
Banner and ASCII art for Vyoma AI Security Scanner
"""
...
def display_banner():
    """Display the Vyoma AI Security Scanner banner (Windows compatible)"""
    ...
    print(f"    Author: Cahyo Darujati")
    print(f"    Email: cahyod@yahoo.co.id")
    print(f"    GitHub: https://github.com/cahyod/vyoma")
    print()
